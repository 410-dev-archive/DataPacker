...
class GraphicComponents {
    ...
    public func selectFile(canChooseDirectories: Bool, canChooseFiles: Bool, showsResizeIndicator: Bool, showsHiddenFiles: Bool, allowMultipleSelections: Bool, title: String) -> String {
        let dialog = NSOpenPanel()
        dialog.title = title
        dialog.showsResizeIndicator = showsResizeIndicator
        dialog.showsHiddenFiles = showsHiddenFiles
        dialog.allowsMultipleSelection = allowMultipleSelections
...
//class NotificationManager: NSUserNotificationCenterDelegate {
