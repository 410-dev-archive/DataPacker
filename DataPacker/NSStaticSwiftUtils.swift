...
class NSSwiftUtils {
    ...
    @discardableResult
    public static func executeShellScriptWithOneLine(_ args: String) -> Int32 {
        let task = Process()
        task.launchPath = "/usr/bin/env"
    ...
    public static func executeShellScriptWithRootPrivilages(pass: String, _ args: String) -> Int32 {
        return pipeCommandline(primaryCommand: "echo#" + pass, execCommands: "sudo#-S#" + args).exitcode
    }
...
//    }
    ...
    public static func runCommand(_ args : String...) -> (output: [String], error: [String], exitCode: Int32) {
    ...
    @discardableResult
    public static func pipeCommandline(primaryCommand: String, execCommands: String) -> (exitcode: Int32, output: String, error: String) {
        let pipe = Pipe()
        let echo = Process()
        ...
        uniq.waitUntilExit()
        return (uniq.terminationStatus, output, error)
    }
    ...
    public static func getEUID() -> String {
        return ProcessInfo().environment["EUID"] ?? "-1"
    }
